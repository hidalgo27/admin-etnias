    ...
    <div class="col-12">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">NUEVO TRANSPORTE</li>
            </ol>
        </nav>
    </div>
    <div class="col-12">
                                ...
                                <div class="row">
                                    <div class="col-4 card">
                                        <div class="row">
                                            ...
                                            <div id="distrito_id" class="form-group col-6">
                                            ...
                                            <div class="form-group col-6">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="tipo_producto" id="tipo_producto_p" value="PRIVADO">
